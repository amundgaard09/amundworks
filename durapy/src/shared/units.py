...
from .numval_types import Unit, Dimension
...
UNIGUNIT = Unit(symbol="UNI_G", dimension=Dimension((F3, F_1, F_2, F0, F0, F0, F0))) # L^3 / M * T^2
...
ELECTRONVOLT = Unit(symbol="eV", dimension=Dimension((F2, F1, F_2, F0, F0, F0, F0)), scale=6.242e18) # L^2 * M / T^2
...
RADIAN    = Unit(symbol="rad", dimension=Dimension((F0, F0, F0, F0, F0, F0, F0)), scale=1) #
DEGREE    = Unit(symbol="deg", dimension=Dimension((F0, F0, F0, F0, F0, F0, F0)), scale=0.01745329251) # PI/180
