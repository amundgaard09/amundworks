...
class EmotionMatrix:
    def __init__(self, 
            empathy: float | None = 0.5,   patience: float | None = 1.0,   formality: float | None = 1.0, 
            curiosity: float | None = 0.7, skepticism: float | None = 0.3, boredom: float | None = 0.0, 
            caution: float | None = 0.5,   composure: float | None = 1.0
        ):
        # Iteraction States
    ...
    def __eq__(self, other: EmotionMatrix):
        return (self.empathy == other.empathy 
