...
class EmotionMatrix:
    def __init__(self,
            empathy: float = 0.5,   patience: float  = 1.0,
            formality: float = 1.0, curiosity: float = 0.7,
            skepticism: float = 0.3, boredom: float = 0.0,
            caution: float = 0.5,   composure: float = 1.0
        ):
        # Iteraction States
